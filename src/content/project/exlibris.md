...
descriptionFr: >-
  L’idée d’EX-LIBRIS est née quelques jours avant mon pèlerinage au Artblocks
  Marfa Weekend en septembre. Ce qui devait être des signets pour un cercle
  restreint s’est transformé en révélation du potentiel créatif de ce format
  modeste. De cette première série, seuls 32 signets ont vu le jour.


  Ces signets, conçus avec soin et désir d’apprendre, sont plus que des
  marque-pages : ils portent un récit d’exploration artistique, de découverte
  de soi et de liens humains. C’est à ce moment qu’a germé l’idée d’inscrire ce
  projet sur la blockchain.


  EX-LIBRIS témoigne de l’union entre la créativité et les possibilités offertes
  par la blockchain. Chaque signet, œuvre à part entière, est un fragment de ce
  parcours. Dans un esprit d’unicité, chaque détenteur pourra récupérer son
  signet (ou sa série) après le mint, en témoignage tangible et signé de cette
  démarche artistique.


  EX-LIBRIS capture l’essence d’un moment où j’ai trouvé ma tribu d’artiste et
