...
const images = {
				...
				const frontmatter = {"title":"Peur et Dégoût à Limoilou","slug":"korrigane/2","publishDate":"2023-05-15T12:00:00.000Z","img":"/assets/2_thumb.webp","collection":"exhibition","img_alt":"Thumbnail for the single post of the artwork","description":"Perlin noise algorithm that sort colours according to an array of values.\n","tags":["Generative art","Exhibitions","Physicals"]};
				const file = "/Users/jbarbeau/Sites/homepage/src/content/exhibition/2.md";
				const url = undefined;
				function rawContent() {
