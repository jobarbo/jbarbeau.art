...
const images = {
				...
				const frontmatter = {"title":"Markdown Mystery Tour","publishDate":"2020-03-02T00:00:00.000Z","img":"/assets/stock-1.jpg","collection":"work","img_alt":"Iridescent ripples of a bright blue and pink liquid","description":"We designed a whodunnit-style game to introduce Markdown formatting. Suspense — suspicion — syntax!\n","tags":["Design","Dev","User Testing"]};
				const file = "/Users/jbarbeau/Sites/homepage/src/content/work/markdown-mystery-tour.md";
				const url = undefined;
				function rawContent() {
