...
const images = {
				...
				const frontmatter = {"title":"La Simulation.","slug":"korrigane/5","publishDate":"2023-05-15T12:00:00.000Z","img":"/assets/5_thumb.webp","collection":"exhibition","img_alt":"Thumbnail for the single post of the artwork","description":"Perlin noise algorithm that draws a sandy beach\n","tags":["Generative art","Exhibitions","Physicals"]};
				const file = "/Users/jbarbeau/Sites/homepage/src/content/exhibition/5.md";
				const url = undefined;
				function rawContent() {
