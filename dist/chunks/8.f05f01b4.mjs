...
const images = {
				...
				const frontmatter = {"title":"Acer Rubrum","slug":"korrigane/8","publishDate":"2023-05-15T12:00:00.000Z","img":"/assets/8_thumb.webp","collection":"exhibition","img_alt":"Thumbnail for the single post of the artwork","description":"Perlin noise algorithm that draws a sandy beach\n","tags":["Generative art","Exhibitions","Physicals"]};
				const file = "/Users/jbarbeau/Sites/homepage/src/content/exhibition/8.md";
				const url = undefined;
				function rawContent() {
